...
//     /// as many methods as needed. 
//     /// </summary>
//     public BenchmarkValidator<T, P> Expect(string methodName, BenchmarkExpectations exp) {
//         return new BenchmarkValidator<T, P>(name).Expect(methodName, exp);
//     }
...
//         return new BenchmarkValidatorWithConfig<T, P>([], config);
//     }
// }
